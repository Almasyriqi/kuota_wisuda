            ...
            <div class="card-body fs-6 text-gray-700">
                <table id="table" class="table align-middle table-row-dashed fs-6 gy-5">
                    ...
                    <tbody class="fw-semibold fs-7 text-gray-600">
                        ...
                        <tr class="text-start">
                            <td>Wisuda Ke-{{$item->nama}}</td>
                            <td>Gelombang {{$item->gel}}</td>
                            <td>{{$item->jenis}}</td>
                            <td>{{$item->tanggal_wisuda}}</td>
                            <td>{{$item->kuota}}</td>
                            <td>{{$item->current_kuota}}</td>
                            <td>
                                <div class="dropdown text-start">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-auto min-w-200 mw-300px"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{route('wisuda.edit', $item->id)}}"
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="{{route('kuota_prodi.index', ['gelombang_id'=>$item->id])}}"
                                                class="menu-link px-3">
                                                Kuota Prodi
                                            </a>
                                        </div>
        ...
        <div class="modal-content">
            <form action="{{route('wisuda.store')}}" method="post">
                ...
                <div class="modal-header">
                    <h3 class="modal-title">Tambah Gelombang Wisuda</h3>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-5">
                        <Label class="form-label required fs-6 fw-bold mt-2 mb-3">Set Kuota Wisuda</Label>
